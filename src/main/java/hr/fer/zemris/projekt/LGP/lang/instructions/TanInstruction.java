...
public class TanInstruction implements EasyLGPInstruction {
	...
	public TanInstruction(int opRegister, int resRegister) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof TanInstruction))
			return false;
		TanInstruction other = (TanInstruction) obj;
