...
public class SinInstruction implements EasyLGPInstruction {
	...
	public SinInstruction(int opRegister, int resRegister) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SinInstruction))
			return false;
		SinInstruction other = (SinInstruction) obj;
