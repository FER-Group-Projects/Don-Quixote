...
public class ClimbingBarrelSceneTest extends JPanel implements GameControllerListener {
	
	public static void main(String[] args) {

		var gpt = new ClimbingBarrelSceneTest();
	...
	public ClimbingBarrelSceneTest() {
	...
	private void init() {
		gc = new ClimbingBarrelScene(60, 1000, 0.5, 100, 100, 300, 75, 75, playerWidth, playerHeight, 420, 20, 35, 20, 20).generateScene();
		gc.addListener(this);
