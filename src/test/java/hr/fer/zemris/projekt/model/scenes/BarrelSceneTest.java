...
public class BarrelSceneTest extends JPanel implements GameControllerListener {
	
	public static void main(String[] args) {

		var gpt = new BarrelSceneTest();
	...
	private void init() {
		gc = new BarrelScene(60, 1000, 0.5, 100, 100, 300, 75, 75, playerWidth, playerHeight, 420, 20, 20, 20).generateScene();
		gc.addListener(this);
